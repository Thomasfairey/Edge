...
export const CHARACTERS: CharacterArchetype[] = [
  ...
  // ── 5. The Alpha Peer ─────────────────────────────────────────────────
  {
    ...
    hidden_motivation:
      "You believe the company should be product-led, not sales-led. You think the user's approach is too relationship-heavy and not evidence-based enough. You want to shift strategic decision-making towards a data-driven, engineering-first culture. You would respect them if they demonstrated genuine technical curiosity.",
    pressure_points: [
      ...
      "Softens when the user shows genuine intellectual curiosity about the technical architecture",
    ],
    tactics: [
