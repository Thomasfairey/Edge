    ...
    <main className="mx-auto max-w-[480px] px-5 pb-10">
      <div className="flex min-h-[90dvh] flex-col items-center justify-center gap-7">
        ...
        <div className="text-center">
          ...
          <p className="mt-3 text-body font-medium" style={{ color: "var(--text-primary)" }}>
            Day {dayNumber}
            {streakCount > 0 && (
              <span className="animate-count-up ml-2" style={{ color: "var(--score-mid)" }}>
        ...
        {/* Score circles row */}
        <div className="flex w-full items-start justify-center gap-3 px-1">
            ...
            return (
              <div key={key} className="flex flex-col items-center gap-2 min-w-0">
                <button
                  ...
                  className="flex items-center justify-center rounded-full text-body font-bold transition-all"
                  style={{
                    width: 52,
                    height: 52,
                ...
                {isExpanded && (
                  <div className="animate-fade-in-up w-40 rounded-[var(--radius-lg)] bg-white p-3.5 text-center" style={{ boxShadow: "var(--shadow-elevated)" }}>
        ...
        {hasIncompleteSession && (
          <div className="w-full card">
            ...
            <p className="mt-1 text-caption" style={{ color: "var(--text-secondary)" }}>Pick up where you left off?</p>
